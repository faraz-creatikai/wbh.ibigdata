...
import { priceDialogDataInterface, priceGetDataInterface } from "@/store/masters/price/price.interface";
import { deletePrice, getPrice } from "@/store/masters/price/price";

export default function PricePage() {
    const [price, setPrice] = useState<priceGetDataInterface[]>([]);
    const [keyword, setKeyword] = useState("");
    const [limit, setLimit] = useState("10");
    const [isDeleteDialogOpen, setIsDeleteDialogOpen] = useState(false);
    const [deleteDialogData, setDeleteDialogData] = useState<priceDialogDataInterface | null>(null);
    ...
    const fetchPrice = async () => {
        ...
        if (data) {
            const formattedData = data.map((r: priceGetDataInterface) => ({
                ...r,
    ...
    // Delete price
    const handleDelete = async (data: priceDialogDataInterface | null) => {
        if (!data) return;
    ...
    const handleEdit = (id?: string) => {
        router.push(`/masters/price/edit/${id}`);
    };
    ...
    const totalTablePages = Math.ceil(filteredPrice.length / rowsPerTablePage);
    const indexOfLastRow = currentTablePage * rowsPerTablePage;
    const indexOfFirstRow = indexOfLastRow - rowsPerTablePage;
    const currentRows = filteredPrice.slice(indexOfFirstRow, indexOfLastRow);
    ...
    return (
        <MasterProtectedRoute>
            ...
            <div className="min-h-[calc(100vh-56px)] overflow-auto max-md:py-10">
                ...
                {/* Delete Dialog */}
                <DeleteDialog<priceDialogDataInterface>
                ...
                <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200 relative">
                    <PageHeader title="Dashboard" subtitles={["Price"]} />
                    {/* Add Button */}

                    <AddButton
                        url="/masters/price/add"
                        text="Add"
