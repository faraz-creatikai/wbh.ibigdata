...
import { contacttypeAllDataInterface, contacttypeGetDataInterface } from "@/store/masters/contacttype/contacttype.interface";
import { getContactTypeById, updateContactType } from "@/store/masters/contacttype/contacttype";
...
export default function ContactTypeEdit() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const result = await updateContactType(id as string, contactTypeData);
      if (result) {
      ...
      console.error("Contact Type Edit Error:", error);
    }
  };
