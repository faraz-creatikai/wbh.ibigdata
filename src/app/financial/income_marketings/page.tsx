...
export default function FinanceIncome() {
  ...
  const incomes = ["Sales", "Commission", "Investment"];
        ...
        <div className="p-4 w-full bg-white rounded-md">
          ...
          <div className=" mt-6 p-5 rounded-md ">
            ...
            <div className=" grid grid-cols-3 max-lg:grid-cols-2 max-md:grid-cols-1 gap-5">
              ...
              />
              <SingleSelect
                options={Array.isArray(fieldOptions?.Incomes) ? fieldOptions.Incomes : []}
                label="Income"
                value={filters.Income[0]}
                onChange={(val) => handleSelectChange("Income", val)}
              />
              <SingleSelect
              ...
              <table className="table-auto w-full border-collapse text-sm border border-gray-200">
                <thead className="bg-[var(--color-primary)] text-white">
                  <tr>
                    ...
                    <th className="px-4 py-3 border border-[var(--color-secondary-dark)] text-left">Income</th>
                  ...
                  {currentRows.length > 0 ? (
                    currentRows.map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 border border-gray-200">{item.Income}</td>
