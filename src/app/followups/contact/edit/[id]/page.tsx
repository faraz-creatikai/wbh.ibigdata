...
import { getFollowupByFollowupId, updateContactFollowup } from "@/store/contactFollowups";
...
export default function ContactFollowupEdit() {
  ...
  const handleSubmit = async () => {
    ...
    if (data) {
      toast.success("Contact Followup updated successfully!");
          ...
          <form onSubmit={(e) => e.preventDefault()}>
            <div className="mb-8 text-left border-b pb-4 border-gray-200">
              <h1 className="text-3xl font-extrabold text-[var(--color-secondary-darker)] leading-tight tracking-tight">
                Edit <span className="text-[var(--color-primary)]
">Contact Followup</span>
            ...
            <div className="flex flex-col space-y-10">
              ...
              <div className="flex justify-end mt-6">
                ...
                <SaveButton text="Save Changes" onClick={handleSubmit} />
