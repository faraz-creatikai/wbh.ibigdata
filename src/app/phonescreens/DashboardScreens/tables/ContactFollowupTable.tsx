        ...
        <>
            ...
            <div className="px-0 pb-4">
                ...
                {paginatedLeads.filter(
                    ...
                    return <div key={index} className="w-full  bg-white dark:bg-[var(--color-childbgdark)] shadow-md rounded-xl overflow-hidden border dark:border-none border-gray-200 mb-0">
                        ...
                        <div className="flex justify-between items-start p-4">
                            ...
                            <button
                                ...
                                className="p-2 bg-gray-100 rounded-full dark:bg-[var(--color-primary)] dark:text-white shadow text-[var(--color-primary)]"
                            >
                                <MdAdd size={20} />
