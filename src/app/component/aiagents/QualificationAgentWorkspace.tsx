...
import { getCustomer, getQualification, updateCustomer } from '@/store/customer'
...
useEffect(() => {
    ...
    const handleSubmit = async () => {
        ...
        setIsLoading(true)
        try {
            const res = await getQualification({ customerId: selectedId, userPrompt: userText })
...
export default QualificationAgentWorkspace